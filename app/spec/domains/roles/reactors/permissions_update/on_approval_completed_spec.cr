...
describe CrystalBank::Domains::Roles::Reactors::PermissionsUpdate::OnApprovalCompleted do
  it "applies new permissions to the role and marks the update request completed" do
    ...
    Roles::Reactors::PermissionsUpdate::OnApprovalCompleted.new.call(completed_event)
  ...
  it "ignores a completed approval for a different source aggregate type" do
    ...
    # Should not raise — OnApprovalCompleted silently returns for non-RolePermissionsUpdate types
    Roles::Reactors::PermissionsUpdate::OnApprovalCompleted.new.call(completed_event)
  end
  ...
  it "does not re-apply permissions when the update request aggregate is already completed" do
    ...
    # OnApprovalCompleted fires but the update request is already completed — role must stay at v2
    Roles::Reactors::PermissionsUpdate::OnApprovalCompleted.new.call(approval_completed)
