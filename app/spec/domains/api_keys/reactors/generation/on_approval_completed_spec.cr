...
describe CrystalBank::Domains::ApiKeys::Reactors::Generation::OnApprovalCompleted do
  it "activates the api key after the approval is completed" do
    ...
    ApiKeys::Reactors::Generation::OnApprovalCompleted.new.call(completed_event)
