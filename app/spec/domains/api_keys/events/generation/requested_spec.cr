...
describe CrystalBank::Domains::ApiKeys::Generation::Events::Requested do
  it "can be initialized" do
    event = Test::ApiKey::Events::Generation::Requested.new.create
    ...
    event.header.event_handle.should eq("api_key.generation.requested")
    event.body.comment.should eq("test comment")
  end

  it "can be initialized from json" do
    object = Test::ApiKey::Events::Generation::Requested.new
    event = object.create
    h = event.header

    json_body = JSON.parse(object.json_string)

    e = ApiKeys::Generation::Events::Requested.new(h, json_body)
    b = e.body.as(ApiKeys::Generation::Events::Requested::Body)
  ...
  it "can serialize to json" do
    ...
    b = event.body.as(ApiKeys::Generation::Events::Requested::Body)
  ...
  it "can serialize and deserialize from json" do
    ...
    e = ApiKeys::Generation::Events::Requested.new(h, JSON.parse(json_body))
