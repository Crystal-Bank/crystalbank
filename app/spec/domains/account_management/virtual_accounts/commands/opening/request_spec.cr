...
describe CrystalBank::Domains::VirtualAccounts::Opening::Commands::Request do
  ...
  it "raises when parent account does not exist" do
    ...
    expect_raises(CrystalBank::Exception::InvalidArgument, /does not exist/) do
      VirtualAccounts::Opening::Commands::Request.new.call(request, UUID.v7, context)
    end
  end
  ...
  it "raises when parent account is not active (pending_approval)" do
    ...
    expect_raises(CrystalBank::Exception::InvalidArgument, /not active/) do
      VirtualAccounts::Opening::Commands::Request.new.call(request, account_id, context)
    end
  end
  ...
  it "raises when parent is itself a virtual account" do
    ...
    expect_raises(CrystalBank::Exception::InvalidArgument, /does not exist/) do
      VirtualAccounts::Opening::Commands::Request.new.call(request, virtual_id, context)
    end
  end
  ...
  it "creates a virtual account opening request when parent account is active" do
    ...
    result = VirtualAccounts::Opening::Commands::Request.new.call(request, account_id, context)
