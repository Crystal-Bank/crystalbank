  ...
  module Advice
    module Commands
      class Process < ES::Command
        def call(msg : Shared::Message, scope_id : UUID, actor_id : UUID, original_authorization_id : UUID? = nil) : UUID
          raise ArgumentError.new("Expected MTI 1120, got #{msg.mti}") unless msg.mti == "1120"
          ...
          event = V1993::Advices::Advice::Events::Received.new(
            actor_id: actor_id,
            ...
            original_data_elements: msg.fields[90]?,
            replacement_amounts: msg.fields[95]?,
