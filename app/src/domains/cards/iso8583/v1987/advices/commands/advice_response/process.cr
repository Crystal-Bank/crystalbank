    ...
    module Commands
      class Process < ES::Command
        ...
        def call(advice_id : UUID, msg : Shared::Message, actor_id : UUID) : Nil
          raise ArgumentError.new("Expected MTI 0130, got #{msg.mti}") unless msg.mti == "0130"
          ...
          if ACCEPTED_CODES.includes?(response_code)
            event = V1987::Advices::AdviceResponse::Events::Accepted.new(
            ...
            event = V1987::Advices::AdviceResponse::Events::Rejected.new(
              aggregate_id: advice_id,
              actor_id: actor_id,
              command_handler: self.class.to_s,
              response_code: response_code,
