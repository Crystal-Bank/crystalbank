  ...
  module Queries
    class Accounts
      struct Account
        ...
        @[DB::Field(converter: CrystalBank::Converters::CurrencyArray(CrystalBank::Types::Currencies::Available))]
        getter currencies = Array(CrystalBank::Types::Currencies::Available).new
