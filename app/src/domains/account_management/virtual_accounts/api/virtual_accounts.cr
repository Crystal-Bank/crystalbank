module CrystalBank::Domains::VirtualAccounts
  module Api
    ...
    class VirtualAccounts < CrystalBank::Api::Base
      include CrystalBank::Domains::VirtualAccounts::Api::Requests
      include CrystalBank::Domains::VirtualAccounts::Api::Responses
      base "/accounts"
      ...
      def list_virtual_accounts(
        ...
        accounts = ::VirtualAccounts::Queries::VirtualAccounts.new.list(account_id, context, cursor: cursor, limit: limit + 1).map do |a|
