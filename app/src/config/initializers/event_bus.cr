...
# Credentials — cross-domain trigger (Users onboarded → send password setup email)
bus.subscribe(Users::Onboarding::Events::Accepted, Credentials::Invitation::Commands::SendEmail)

# Credentials — own projections
bus.subscribe(Credentials::Invitation::Events::Sent, Credentials::Projections::Credentials)
bus.subscribe(Credentials::PasswordSetup::Events::Completed, Credentials::Projections::Credentials)
bus.subscribe(Credentials::PasswordReset::Events::Requested, Credentials::Projections::Credentials)
bus.subscribe(Credentials::PasswordReset::Events::Confirmed, Credentials::Projections::Credentials)
bus.subscribe(Credentials::Totp::Events::SetupInitiated, Credentials::Projections::Credentials)
bus.subscribe(Credentials::Totp::Events::Enabled, Credentials::Projections::Credentials)
...
bus.subscribe(Credentials::Invitation::Events::Sent, Events::Projections::Events)
bus.subscribe(Credentials::PasswordSetup::Events::Completed, Events::Projections::Events)
bus.subscribe(Credentials::PasswordReset::Events::Requested, Events::Projections::Events)
bus.subscribe(Credentials::PasswordReset::Events::Confirmed, Events::Projections::Events)
bus.subscribe(Credentials::Totp::Events::Enabled, Events::Projections::Events)
