...
bus.subscribe(Ledger::Transactions::Request::Events::Accepted, Ledger::Transactions::Projections::LedgerEntries)

# Transactions (internal_transfers commented out pending redesign to write to ledger_entries)
